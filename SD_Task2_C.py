...
class Server:
	_sync = {'push_data':1}
	_async = ['set_queue_server','connect_database']
	_parallel = []
	_ref = []
...
class Write_file():
	...
	def write(self):
		...
		print 'Escribint resultats al fitxer ResultatsB3.txt'

		f= open('ResultatsB3.txt','w')
...
def test():
	...
	host=init_host()
	sensor=host.spawn_id('1','SD_Task2_C','Sensor',[])
	sl1=host.spawn_id('1','SD_Task2_C','Streetlight',[])
	sl2=host.spawn_id('2','SD_Task2_C','Streetlight',[])
	sl3=host.spawn_id('3','SD_Task2_C','Streetlight',[])
	q= host.spawn_id('1','SD_Task2_C','Queue',[])

	
	l=host.spawn_id('1','SD_Task2_C','Write_file',[])
	...
	s1=host.spawn_id('1','SD_Task2_C','Server',[])
	s2=host.spawn_id('2','SD_Task2_C','Server',[])
	
	
	db1=host.spawn_id('1','SD_Task2_C','Database',[])
	db2=host.spawn_id('2','SD_Task2_C','Database',[])
	db3=host.spawn_id('3','SD_Task2_C','Database',[])
